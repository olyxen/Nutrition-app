...
function MainBody() {
    return (
      <div>
        ...
        <div class="container">
          <div class="row properties3">
            <div class="text-center col-lg-4">
              <img src="/simple-planning.jpg" class="rounded"></img>
            ...
            <div class="text-center col-lg-4">
              <img src="/easiest-food-tracking.jpg" class="rounded"></img>  
            ...
            <div class="text-center col-lg-4">
              <img src="/advice-feedback.jpg" class="rounded"></img>  
